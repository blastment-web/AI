...
NODE_CPC = {
    ...
    # 활성화
    "고전류 급속 화성":               ["H01M10/44", "H02J7", "H01M10/0525"],
    "가압 화성 (Pressurized formation)": ["H01M10/44", "H01M10/04", "H01M10/052"],
    "에이징 기간 단축 알고리즘":         ["H01M10/48", "G01R31/392", "G01R31/367"],
    "화성 데이터 기반 불량 예측 (AI)":   ["G01R31/367", "G01R31/378", "G06N"],
...
NODE_TERMS = {
    ...
    "고전류 급속 화성":               ["화성", "formation", "급속 충전", "fast charg", "sei"],
    "가압 화성 (Pressurized formation)": ["가압", "pressuriz", "가압 화성", "clamping"],
    "에이징 기간 단축 알고리즘":         ["에이징", "aging", "ocv", "숙성", "잔여 수명"],
    "화성 데이터 기반 불량 예측 (AI)":   ["불량 예측", "defect predict", "내부단락", "internal short", "선별"],
