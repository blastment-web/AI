...
| 버전 | 파일 | 날짜 | 내용 |
|---|---|---|---|
| **V8** | `versions/V8-index.html`<br>`versions/V8-report.pptx` | 2026-09-14 | **4대 핵심 기술군 편입**(차세대 케미스트리·팩 구조·스마트 제조·사업모델, 11개 신설 → 84개). **판단 기준을 건수에서 핵심 특허(다국·등록·피인용)로 전환**. 근거 등급 최상·상·중·하 통일. 기술 상세 전체화면 오버레이 + 그 위 중첩 팝업. 제목 단어화 |
