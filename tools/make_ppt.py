...
def main():
    ...
    helps = [
        f"공정기술 {c['nodes_total']}개 전량 = 열위 {LV['behind']} · 동등 {LV['even']} · "
        f"우위 {LV['ahead']} · 확인 필요 {LV['hold']} · 근거 부족 {LV['none']}",
    ...
    limits = [
        ...
        f"'확인 필요' {LV['hold']}건은 자사 현황 미확인분 · '근거 부족' {LV['none']}건은 "
        "경쟁사 근거 미확보분 — 미확보 대상이 상호 반대임",
